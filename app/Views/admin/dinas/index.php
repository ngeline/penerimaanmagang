...
<h1 class="app-page-title">Kelola Kepala Dinas</h1>
                                    ...
                                    <div class="modal fade" id="Edit<?php echo $no ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <form action="<?= base_url('admin/kepala-dinas/update') ?>" method="POST" enctype="multipart/form-data" files="true">
                                                    <?= csrf_field() ?>
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="mb-3 col-md-6">
                                                                ...
                                                                <input type="text" name="nama" class="form-control" value="<?= $row['kepala_dinas'] ?>">
                                                            </div>
                                                            <div class="mb-3 col-md-6">
                                                            ...
                                                            <div class="mb-3 col-md-12">
                                                                <label class="form-label">Tanda Tangan Kepala Dinas <span style="color: red; font-size: 11px;">*tipe file png, ukuran max 1mb</span></label>
                                                                <div class="row">
                                                                    <div class="col-md-4">
